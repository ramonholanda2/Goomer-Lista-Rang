    ...
    it("add new Restaurant and exclude restaurant", (done) => {
      ...
      chai
        ...
        .end((err, res) => {
          ...
          chai
            .request(app.getApplication())
            .delete(`/restaurants/${res.body.restaurant_id}`)
            .end((err, res) => {
